                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="text-lg-end">
                                <a href="{{ route('inscription') }}"><button class="btn btn-primary"><i class="fa fa-plus"></i> Ajouter</button></a>
                            </div>
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tr>
                                        <td><img class="rounded-circle me-2" width="30" height="30" src="assets/img/avatars/avatar1.jpeg">{{$user->first_name}} {{$user->last_name}}</td>
                                        <td>{{$user->role->role}}</td>
                                        <td>{{$user->email}}</td>
                                        <td>
                                            <div class="btn-group">
                                                <a href=""><i class="fa fa-edit text-success m-1"></i></a>
